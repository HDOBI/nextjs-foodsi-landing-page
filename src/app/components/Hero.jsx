...
function Hero() {
  return (
    <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-center justify-center h-auto lg:h-screen text-center pb-[30px] pt-[130px] sm:pb-[85px] sm:pt-[180px] px-3 lg:px-0">
