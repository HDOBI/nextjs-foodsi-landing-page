...
function testimonial() {
  return (
    <div className="flex flex-col items-center gap-3 sm:gap-4 max-w-[1200px] mx-auto px-3 lg:px-0 text-center py-12 sm:py-16">
      ...
      <p className="max-w-[350px] sm:max-w-[790px] text-[20px] sm:text-[22px] mt-3 sm:mt-2">
      ...
      <div>
        <h5 className="text-[20px] sm:text-[22px]">Matthew Monasterio</h5>
        <span className="text-[16px]">JG Restaurant</span>
      </div>
    </div>
  );
}
